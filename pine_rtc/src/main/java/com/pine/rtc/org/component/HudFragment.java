...
public class HudFragment extends Fragment {
    ...
    public void onStart() {
        ...
        if (args != null) {
            ...
            mDisplayHud = args.getBoolean(CallActivity.EXTRA_DISPLAY_HUD, false);
        }
        int visibility = mDisplayHud ? View.VISIBLE : View.INVISIBLE;
    ...
    public void updateEncoderStatistics(final StatsReport[] reports) {
        ...
        if (mCpuMonitor != null) {
            encoderStat.append("CPU%: ")
                    .append(mCpuMonitor.getCpuUsageCurrent())
                    .append("/")
                    .append(mCpuMonitor.getCpuUsageAverage())
                    .append(". Freq: ")
                    .append(mCpuMonitor.getFrequencyScaleAverage());
        }
