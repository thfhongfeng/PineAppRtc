...
public class ScreenRecordController {
    ...
    private static ScreenRecordController mInstance;
    ...
    public static synchronized ScreenRecordController getInstance() {
        if (mInstance == null) {
            mInstance = new ScreenRecordController();
        }
        return mInstance;
    }
...
//                            + ", bytesWrite:" + bytesWrite + ", speakerMute:" + speakerMute);
    ...
    private boolean feedAudioData() {
        ...
        if (audioOutBuffer == null && audioInBuffer == null) {
            ...
            size = Math.min(audioOutBuffer.capacity(), audioInBuffer.capacity());
    ...
    private boolean writeAudioData() {
        ...
        int outIndex = mAudioCodec.dequeueOutputBuffer(audioBufferInfo, TIMEOUT_US);
    ...
    private void prepareEncoder() throws IOException {
        ...
        audioFormat.setInteger(MediaFormat.KEY_BIT_RATE, mAudioBitsPerSample * mAudioSampleRate);
