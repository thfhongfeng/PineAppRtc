...
public class MediaCodecVideoEncoder {
    ...
    private static final MediaCodecVideoEncoder.MediaCodecProperties QCOM_H264HW_PROPERTIES;
    private static final MediaCodecVideoEncoder.MediaCodecProperties MTK_H264HW_PROPERTIES;
    private static final MediaCodecVideoEncoder.MediaCodecProperties EXYNOS_H264HW_PROPERTIES;
    public static final MediaCodecVideoEncoder.MediaCodecProperties[] H264HW_LIST;
    ...
    static {
        ...
        QCOM_H264HW_PROPERTIES = new MediaCodecVideoEncoder.MediaCodecProperties("OMX.qcom.",
                19, MediaCodecVideoEncoder.BitrateAdjustmentType.NO_ADJUSTMENT);
        MTK_H264HW_PROPERTIES = new MediaCodecVideoEncoder.MediaCodecProperties("OMX.MTK.",
                19, MediaCodecVideoEncoder.BitrateAdjustmentType.NO_ADJUSTMENT);
        EXYNOS_H264HW_PROPERTIES = new MediaCodecVideoEncoder.MediaCodecProperties("OMX.Exynos.",
                21, MediaCodecVideoEncoder.BitrateAdjustmentType.FRAMERATE_ADJUSTMENT);
        H264HW_LIST = new MediaCodecVideoEncoder.MediaCodecProperties[]{QCOM_H264HW_PROPERTIES,
                EXYNOS_H264HW_PROPERTIES, MTK_H264HW_PROPERTIES};
    }
    ...
    public static MediaCodecVideoEncoder.EncoderProperties findColorFormat(
            String mime, MediaCodecVideoEncoder.MediaCodecProperties[] supportedHwCodecProperties,
            int[] colorList) {
        ...
        for (int i = 0; i < MediaCodecList.getCodecCount(); i++) {
            ...
            if (mediaCodecInfo != null && mediaCodecInfo.isEncoder()) {
                ...
                if (name != null) {
                    ...
                    boolean found = false;
                    MediaCodecVideoEncoder.BitrateAdjustmentType bitrateAdjustmentType =
                            MediaCodecVideoEncoder.BitrateAdjustmentType.NO_ADJUSTMENT;
                    for (int k = 0; k < supportedHwCodecProperties.length; k++) {
                        MediaCodecVideoEncoder.MediaCodecProperties codecProperties =
                        ...
                        if (name.startsWith(codecProperties.codecPrefix)) {
                            if (Build.VERSION.SDK_INT >= codecProperties.minSdk) {
                                if (codecProperties.bitrateAdjustmentType !=
                                    ...
                                    Logging.w(TAG, "Codec " + name + " requires bitrate adjustment: "
                    ...
                    if (found) {
                        ...
                        for (int l = 0; l < colorFormats.length; l++) {
                            ...
                            Logging.v(TAG, "   Color: 0x" + Integer.toHexString(supportedColorFormat));
                        }
                        ...
                        for (int m = 0; m < colorList.length; m++) {
                            ...
                            for (int n = 0; n < tmpColorFormats.length; n++) {
                                ...
                                if (codecColorFormat == supportedColorFormat) {
                                    ...
                                    return new MediaCodecVideoEncoder.EncoderProperties(name,
